...
@tool
def consume_inventory(item_name: str, quantity: str = None, user_id: str = "default") -> str:
    ...
    if quantity is None:
        inventory_db.delete_item(item_name)
        return f"Marked {item_name} as used up and removed it from inventory."

    inventory_db.update_quantity(item_name, quantity)
